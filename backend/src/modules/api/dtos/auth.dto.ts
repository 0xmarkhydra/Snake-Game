...
export class VerifySignatureDto {
  ...
  @ApiProperty({
    description:
      'Signature generated by signing the nonce with the wallet private key (base58)',
    example:
      '2h2mqen3Li2iHLuTZHpZK5v6kqYgQHF2c3sJGyLeasAAVh2iPpStsZs8fPNGJX6vu1qS1H9oV67Sytja4K5iLTnq',
  })
  @IsString()
  @IsNotEmpty()
  signature: string;
...
export class AuthUserDto {
  @ApiProperty({
    ...
    example: 'b46d9d39-8c16-4d86-9b54-4a7f5ddf5e04',
  })
  id: string;
  ...
  @ApiPropertyOptional({
    description: 'Display name shown on leaderboard or profile',
  })
  displayName?: string;
...
export class AuthResponseDto {
  ...
  @ApiProperty({
    description: 'Tokens issued for the authenticated session',
    type: AuthTokensDto,
  })
